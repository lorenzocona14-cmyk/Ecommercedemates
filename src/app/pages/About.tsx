...
export function About() {
  return (
    <div className="py-12 bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-green-700 to-green-900 text-white py-16 mb-12">
      ...
      <section className="container mx-auto px-4">
        <div className="bg-green-700 text-white p-12 rounded-lg text-center">
